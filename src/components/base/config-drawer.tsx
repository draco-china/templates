		...
		<Sheet>
			...
			<SheetContent className="flex flex-col">
				<SheetHeader className="pb-0 text-start">
					<SheetTitle>{m.config_title()}</SheetTitle>
	...
	return (
		<div className="max-md:hidden">
			<SectionTitle
				...
				title={m.config_section_sidebar()}
			/>
			<Radio
			...
			>
				{[
					{
						value: "inset",
						label: m.config_sidebar_inset(),
						icon: IconSidebarInset,
					},
					{
						value: "floating",
						label: m.config_sidebar_floating(),
						icon: IconSidebarFloating,
					},
					{
						value: "sidebar",
						label: m.config_sidebar_sidebar(),
		...
		<div className="max-md:hidden">
			...
			>
				{[
					{
						value: "default",
						label: m.config_layout_default(),
						icon: IconLayoutDefault,
					},
					{
						value: "icon",
						label: m.config_layout_compact(),
						icon: IconLayoutCompact,
					},
					{
						value: "offcanvas",
						label: m.config_layout_full(),
						icon: IconLayoutFull,
					},
				].map((item) => (
					<RadioGroupItem item={item} key={item.value} />
	...
	return (
		<div>
			<SectionTitle
				...
				title={m.config_section_direction()}
			/>
			<Radio
